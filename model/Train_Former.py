...
class Train_Former:
    ...
    def Classifajar_former(self):
        ...
        # s_numbr = sjson["Save_dir"]["numbers"]["Min_fc"]
        # t_lower = sjson["Train_dir"]["lowercase"]["Min_fc"]
        # t_upper = sjson["Train_dir"]["uppercase"]["Min_fc"]
        # t_numbr = sjson["Train_dir"]["numbers"]["Min_fc"]
        #
        #
        # if
        #return print("Yay")
